...
void readSims(const int& numFolders, const int& numSims, const int& numData, string* folders, int * exceptions, 
...
void calcWork(const int& numFolders, const int& numSims, const int& numData,
